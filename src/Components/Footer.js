  ...
  return (
    <footer>
      <div className="flex flex-col font-semibold">
        <div className="flex py-6 flex-col items-center flex-1 justify-center sm:justify-between sm:flex-row sm:mr-12">
          <Logo />
          <Link
            to="/"
          ...
          <div className="flex pt-4 flex-row space-x-8 items-center justify-between sm:pt-0">
        ...
        <p className="w-full text-center my-4 text-gray-200">
